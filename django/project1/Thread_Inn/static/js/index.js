    ...
    if (expanded) {
        adm_tools.innerHTML = `
            ...
            <div id="button_admin" style="display: flex;">
                ...
                <button style="background-color: #f45879;"><a href="products/" style="text-decoration: none; color: white;">Products</a></button>  &nbsp; &nbsp;
                <button style="background-color: coral;">Prices</button> &nbsp; &nbsp;
                <button style="background-color: aquamarine; color: #000000;"><a href="product/" style="text-decoration: none; color: black;">Add</a></button> &nbsp; &nbsp;
